...
console.log(`losango que tem D = 32cm e d = 18cm ${Ex.getLosango(32, 18)}`);
console.log(`losango que tem D = 200cm e d = 50cm ${Ex.getLosango(200, 50)}`);
console.log(`losango que tem D = 75cm e d = 25cm ${Ex.getLosango(75, 25)}`);

console.log(`trapézio que tem B = 100cm, b = 70cm e altura = 50cm ${Ex.getAreaTrapezio(100, 70, 50)}`);
console.log(`trapézio que tem B = 75cm, b = 50cm e altura = 35cm = 50cm ${Ex.getAreaTrapezio(75, 50, 35)}`);
console.log(`trapézio que tem B = 150cm, b = 120cm e altura = 80cm ${Ex.getAreaTrapezio(150, 120, 80)}`);

console.log(`círculo de raio igual 25cm ${Ex.getAreaCirculo(25)}`);
console.log(`círculo de raio igual 100cm ${Ex.getAreaCirculo(100)}`);
console.log(`círculo de raio igual 12,5cm ${Ex.getAreaCirculo(12.5)}`);
